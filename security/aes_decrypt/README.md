...
Run the application as
    ```
    ./aes_X86.exe -p Xilinx -d 'xilinx:adm-pcie-ku3:2ddr:2.1' -k ./xclbin/krnl_aes.<emulation flow>.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin -b  data/input.bmp
    ```
...
Run the nimbix-run.py script provided in the utility/nimbix directory at the top level of this repository
    ```
    ../../utility/nimbix/nimbix-run.py ./aes_X86.exe -p Xilinx -d 'xilinx:adm-pcie-ku3:2ddr:2.1' -k ./xclbin/krnl_aes.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin -b data/input.bmp
    ```
