...
create_solution -name vector_dotproduct_zc706 -dir . -force

set_property device_repo_paths "$::env(PWD)/dsa" [current_solution]

# Target a Xilinx FPGA board
#add_device -vbnv xilinx:adm-pcie-7v3:1ddr:2.0
add_device -vbnv xilinx:zc706:uart:1.0
