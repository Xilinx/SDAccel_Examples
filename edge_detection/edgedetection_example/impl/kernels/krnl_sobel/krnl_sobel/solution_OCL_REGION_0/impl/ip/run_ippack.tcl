...
set Library     "hls"
set IPName      "krnl_sobel"
set Version     "1.0"
set DisplayName "Krnl_sobel"
set Revision    "1605251505"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 in_pixels_1 W 0x0 "Data signal of in_pixels" {{0 32 in_pixels W 0 "Bit 31 to 0 Data signal of in_pixels"}}} {0x14 in_pixels_2 W 0x0 "Data signal of in_pixels" {{0 32 in_pixels W 0 "Bit 63 to 32 Data signal of in_pixels"}}} {0x1c nchannels W 0x0 "Data signal of nchannels" {{0 32 nchannels W 0 "Bit 31 to 0 Data signal of nchannels"}}} {0x24 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 Data signal of width"}}} {0x2c height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 Data signal of height"}}} {0x34 out_pixels_1 W 0x0 "Data signal of out_pixels" {{0 32 out_pixels W 0 "Bit 31 to 0 Data signal of out_pixels"}}} {0x38 out_pixels_2 W 0x0 "Data signal of out_pixels" {{0 32 out_pixels W 0 "Bit 63 to 32 Data signal of out_pixels"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 1
set kernel_files {/proj/picasso/pourya/playground/edge_detection/src/krnl_sobelfilter_pipelined_asyncmem.cl}
if {$enable_xo_gen} {
