...
@krnl_sobel.rowbuf0 = internal  global [4096 x i8] zeroinitializer, align 1 ; [#uses=2 type=[4096 x i8] *]
@krnl_sobel.rowbuf1 = internal  global [4096 x i8] zeroinitializer, align 1 ; [#uses=2 type=[4096 x i8] *]
@krnl_sobel.rowbuf2 = internal  global [4096 x i8] zeroinitializer, align 1 ; [#uses=6 type=[4096 x i8] *]
@krnl_sobel.resbuf = internal  global [4096 x i8] zeroinitializer, align 1 ; [#uses=3 type=[4096 x i8] *]
...
; [#uses=0]
define  void @krnl_sobel(i32 addrspace(1)* %gmem, %struct.krnl_sobel_args_t* %args) {
  ...
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str5, i32 0, i32 0), i64* %1) nounwind, !dbg !109 ; [debug line = 30:5@61:1]
  %2 = getelementptr inbounds %struct.krnl_sobel_args_t* %args, i32 0, i32 1, !dbg !111 ; [#uses=1 type=i32*] [debug line = 31:5@61:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0), i32* %2) nounwind, !dbg !111 ; [debug line = 31:5@61:1]
  %3 = getelementptr inbounds %struct.krnl_sobel_args_t* %args, i32 0, i32 2, !dbg !112 ; [#uses=1 type=i32*] [debug line = 32:5@61:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str7, i32 0, i32 0), i32* %3) nounwind, !dbg !112 ; [debug line = 32:5@61:1]
  %4 = getelementptr inbounds %struct.krnl_sobel_args_t* %args, i32 0, i32 3, !dbg !113 ; [#uses=1 type=i32*] [debug line = 33:5@61:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8]* @.str8, i32 0, i32 0), i32* %4) nounwind, !dbg !113 ; [debug line = 33:5@61:1]
  %5 = getelementptr inbounds %struct.krnl_sobel_args_t* %args, i32 0, i32 4, !dbg !114 ; [#uses=1 type=i64*] [debug line = 34:5@61:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str9, i32 0, i32 0), i64* %5) nounwind, !dbg !114 ; [debug line = 34:5@61:1]
  ...
  call  void (...)* @_ssdm_op_SpecInterface(%struct.krnl_sobel_args_t* %args, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !117 ; [debug line = 64:1]
  call  void (...)* @_ssdm_InlineRegion(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !118 ; [debug line = 46:3]
  ...
  call  void @llvm.dbg.declare(metadata !{[3 x [3 x i32]]* %GX.i.i}, metadata !161) nounwind, !dbg !165 ; [debug line = 82:6] [debug variable = GX]
  %164 = bitcast [3 x [3 x i32]]* %GX.i.i to i8*, !dbg !166 ; [#uses=1 type=i8*] [debug line = 86:3]
  call  void @llvm.memset.p0i8.i64(i8* %164, i8 0, i64 36, i32 4, i1 false) nounwind, !dbg !166 ; [debug line = 86:3]
  ...
  call  void @llvm.dbg.declare(metadata !{[3 x [3 x i32]]* %GY.i.i}, metadata !167) nounwind, !dbg !168 ; [debug line = 88:6] [debug variable = GY]
  %171 = bitcast [3 x [3 x i32]]* %GY.i.i to i8*, !dbg !169 ; [#uses=1 type=i8*] [debug line = 92:3]
  call  void @llvm.memset.p0i8.i64(i8* %171, i8 0, i64 36, i32 4, i1 false) nounwind, !dbg !169 ; [debug line = 92:3]
...
; <label>:180                                     ; preds = %178
  ...
  %182 = getelementptr inbounds [4096 x i8] * @krnl_sobel.resbuf, i64 0, i64 %181, !dbg !172 ; [#uses=1 type=i8 *] [debug line = 106:9]
  store i8 -1, i8 * %182, align 1, !dbg !172 ; [debug line = 106:9]
...
_Z21async_work_grou.rexit.i.i:                    ; preds = %.rentry.i.i
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.0167.reg2mem.0.i.i, i32 addrspace(1)* %arg_out_pixels.i.0, i64 %.reg2mem549.0.i.i, i64 1) nounwind
  %CI326.i.i = bitcast i32 addrspace(1)* %.0167.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* %CI326.i.i, i8* bitcast ([4096 x i8] * @krnl_sobel.resbuf to i8*), i64 %.0165.reg2mem.0.i.i, i32 1, i1 false) nounwind
...
_Z21async_work_grou.i.i:                          ; preds = %.rentry.i.i
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %arg_in_pixels.i.0, i32 addrspace(1)* %arg_in_pixels.i.0, i32 0, i64 1) nounwind
  %CI.i.i = bitcast i32 addrspace(1)* %arg_in_pixels.i.0 to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf0 to i8*), i8* %CI.i.i, i64 %.0168.reg2mem.0.i.i, i32 1, i1 false) nounwind
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.0161.reg2mem.0.i.i, i32 addrspace(1)* %arg_in_pixels.i.0, i64 %.reg2mem543.0.i.i, i64 1) nounwind
  %CI216.i.i = bitcast i32 addrspace(1)* %.0161.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf1 to i8*), i8* %CI216.i.i, i64 %.0162.reg2mem.0.i.i, i32 1, i1 false) nounwind
  br label %.rentry743.i.i, !dbg !182             ; [debug line = 124:13]

.rentry743.i.i:                                   ; preds = %446, %_Z21async_work_grou.i.i
  %prow0.0.reg2mem735.0.i.i = phi i8 * [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf0, i64 0, i64 0), %_Z21async_work_grou.i.i ], [ %prow1.0.reg2mem733.0.i.i, %446 ] ; [#uses=2 type=i8 *]
  %prow1.0.reg2mem733.0.i.i = phi i8 * [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf1, i64 0, i64 0), %_Z21async_work_grou.i.i ], [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 0), %446 ] ; [#uses=3 type=i8 *]
...
_Z21async_work_grou745.rexit.i.i:                 ; preds = %.rentry743.i.i
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.0158.reg2mem.0.i.i, i32 addrspace(1)* %arg_in_pixels.i.0, i64 %.reg2mem531.0.i.i, i64 1) nounwind
  %CI307.i.i = bitcast i32 addrspace(1)* %.0158.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf2 to i8*), i8* %CI307.i.i, i64 %.0159.reg2mem.0.i.i, i32 1, i1 false) nounwind
...
; <label>:193                                     ; preds = %190
  call  void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([13 x i8]* @hls_region, i64 0, i64 0)) nounwind
  call  void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([13 x i8]* @hls_region, i64 0, i64 0)) nounwind
...
; <label>:196                                     ; preds = %194
  ...
  %203 = getelementptr inbounds i8 * %prow0.0.reg2mem735.0.i.i, i64 %202, !dbg !191 ; [#uses=1 type=i8 *] [debug line = 142:17]
  %204 = load i8 * %203, align 1, !dbg !191 ; [#uses=1 type=i8] [debug line = 142:17]
  ...
  %215 = getelementptr inbounds i8 * %prow1.0.reg2mem733.0.i.i, i64 %214, !dbg !193 ; [#uses=1 type=i8 *] [debug line = 143:17]
  %216 = load i8 * %215, align 1, !dbg !193 ; [#uses=1 type=i8] [debug line = 143:17]
  ...
  %227 = getelementptr inbounds [4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 %226, !dbg !194 ; [#uses=1 type=i8 *] [debug line = 144:17]
  %228 = load i8 * %227, align 1, !dbg !194 ; [#uses=1 type=i8] [debug line = 144:17]
  ...
  %238 = getelementptr inbounds i8 * %prow0.0.reg2mem735.0.i.i, i64 %237, !dbg !195 ; [#uses=1 type=i8 *] [debug line = 146:17]
  %239 = load i8 * %238, align 1, !dbg !195 ; [#uses=1 type=i8] [debug line = 146:17]
  ...
  %250 = getelementptr inbounds i8 * %prow1.0.reg2mem733.0.i.i, i64 %249, !dbg !196 ; [#uses=1 type=i8 *] [debug line = 147:17]
  %251 = load i8 * %250, align 1, !dbg !196 ; [#uses=1 type=i8] [debug line = 147:17]
  ...
  %262 = getelementptr inbounds [4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 %261, !dbg !197 ; [#uses=1 type=i8 *] [debug line = 148:17]
  %263 = load i8 * %262, align 1, !dbg !197 ; [#uses=1 type=i8] [debug line = 148:17]
...
._crit_edge.i.i:                                  ; preds = %194
  ...
  call  void @_ZN15sw_em_force_ftzC1Ev(%class.sw_em_force_ftz* %fftz.i.i.i.i.i) nounwind
...
_Z4sqrtf.exit.i.i:                                ; preds = %hls_ldexp.exit.i.i.i.i.i, %294, %hls_isinf.exit.i.i.i.i.i, %._crit_edge103.i.i, %._crit_edge.i.i
  ...
  call  void @_ZN15sw_em_force_ftzD1Ev(%class.sw_em_force_ftz* %fftz.i.i.i.i.i) nounwind
  ...
  call  void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([13 x i8]* @hls_region, i64 0, i64 0)) nounwind
...
_Z21async_work_grou746.i.i:                       ; preds = %.rentry743.i.i
  ...
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf0 to i8*), i8* %CI231.i.i, i64 %.074.reg2mem.0.i.i, i32 1, i1 false) nounwind
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.078.reg2mem.0.i.i, i32 addrspace(1)* %arg_in_pixels.i.0, i64 %.reg2mem353.0.i.i, i64 1) nounwind
  %CI250.i.i = bitcast i32 addrspace(1)* %.078.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf1 to i8*), i8* %CI250.i.i, i64 %.077.reg2mem.0.i.i, i32 1, i1 false) nounwind
...
.rentry749.rentry.i.i:                            ; preds = %_Z21async_work_grou753.rexit.i.i, %_Z21async_work_grou746.i.i
  %prow0.1.reg2mem645.0.i.i = phi i8 * [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf0, i64 0, i64 0), %_Z21async_work_grou746.i.i ], [ %prow1.1.reg2mem643.0.i.i, %_Z21async_work_grou753.rexit.i.i ] ; [#uses=2 type=i8 *]
  %prow1.1.reg2mem643.0.i.i = phi i8 * [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf1, i64 0, i64 0), %_Z21async_work_grou746.i.i ], [ getelementptr inbounds ([4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 0), %_Z21async_work_grou753.rexit.i.i ] ; [#uses=3 type=i8 *]
...
_Z21async_work_grou751.rexit.i.i:                 ; preds = %.rentry749.rentry.i.i
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.081.reg2mem.0.i.i, i32 addrspace(1)* %arg_in_pixels.i.0, i64 %.reg2mem343.0.i.i, i64 1) nounwind
  %CI269.i.i = bitcast i32 addrspace(1)* %.081.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([4096 x i8] * @krnl_sobel.rowbuf2 to i8*), i8* %CI269.i.i, i64 %.080.reg2mem.0.i.i, i32 1, i1 false) nounwind
...
; <label>:454                                     ; preds = %451
  call  void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([13 x i8]* @hls_region7, i64 0, i64 0)) nounwind
  call  void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([13 x i8]* @hls_region7, i64 0, i64 0)) nounwind
...
; <label>:457                                     ; preds = %455
  ...
  %464 = getelementptr inbounds i8 * %prow0.1.reg2mem645.0.i.i, i64 %463, !dbg !217 ; [#uses=1 type=i8 *] [debug line = 190:17]
  %465 = load i8 * %464, align 1, !dbg !217 ; [#uses=1 type=i8] [debug line = 190:17]
  ...
  %476 = getelementptr inbounds i8 * %prow1.1.reg2mem643.0.i.i, i64 %475, !dbg !219 ; [#uses=1 type=i8 *] [debug line = 191:17]
  %477 = load i8 * %476, align 1, !dbg !219 ; [#uses=1 type=i8] [debug line = 191:17]
  ...
  %488 = getelementptr inbounds [4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 %487, !dbg !220 ; [#uses=1 type=i8 *] [debug line = 192:17]
  %489 = load i8 * %488, align 1, !dbg !220 ; [#uses=1 type=i8] [debug line = 192:17]
  ...
  %499 = getelementptr inbounds i8 * %prow0.1.reg2mem645.0.i.i, i64 %498, !dbg !221 ; [#uses=1 type=i8 *] [debug line = 194:17]
  %500 = load i8 * %499, align 1, !dbg !221 ; [#uses=1 type=i8] [debug line = 194:17]
  ...
  %511 = getelementptr inbounds i8 * %prow1.1.reg2mem643.0.i.i, i64 %510, !dbg !222 ; [#uses=1 type=i8 *] [debug line = 195:17]
  %512 = load i8 * %511, align 1, !dbg !222 ; [#uses=1 type=i8] [debug line = 195:17]
  ...
  %523 = getelementptr inbounds [4096 x i8] * @krnl_sobel.rowbuf2, i64 0, i64 %522, !dbg !223 ; [#uses=1 type=i8 *] [debug line = 196:17]
  %524 = load i8 * %523, align 1, !dbg !223 ; [#uses=1 type=i8] [debug line = 196:17]
...
._crit_edge128.i.i:                               ; preds = %455
  ...
  call  void @_ZN15sw_em_force_ftzC1Ev(%class.sw_em_force_ftz* %fftz.i.i.i65.i.i) nounwind
...
_Z4sqrtf.exit95.i.i:                              ; preds = %hls_ldexp.exit.i.i.i94.i.i, %555, %hls_isinf.exit.i.i.i84.i.i, %._crit_edge135.i.i, %._crit_edge128.i.i
  ...
  call  void @_ZN15sw_em_force_ftzD1Ev(%class.sw_em_force_ftz* %fftz.i.i.i65.i.i) nounwind
  ...
  %711 = getelementptr inbounds [4096 x i8] * @krnl_sobel.resbuf, i64 0, i64 %710, !dbg !228 ; [#uses=1 type=i8 *] [debug line = 204:13]
  store i8 %709, i8 * %711, align 1, !dbg !228 ; [debug line = 204:13]
  %.reg2mem176.0.i.i = add nsw i32 %x4.0.reg2mem639.0.i.i, 1, !dbg !229 ; [#uses=1 type=i32] [debug line = 182:31]
  call  void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([13 x i8]* @hls_region7, i64 0, i64 0)) nounwind
...
_Z21async_work_grou753.rexit.i.i:                 ; preds = %451
  ...
  call  void (...)* @_ssdm_xcl_PointerMap(i32 addrspace(1)* %.047.reg2mem.0.i.i, i32 addrspace(1)* %arg_out_pixels.i.0, i64 %.reg2mem173.0.i.i, i64 1) nounwind
  %CI288.i.i = bitcast i32 addrspace(1)* %.047.reg2mem.0.i.i to i8* ; [#uses=1 type=i8*]
  call  void @llvm.memcpy.p0i8.p0i8.i64(i8* %CI288.i.i, i8* bitcast ([4096 x i8] * @krnl_sobel.resbuf to i8*), i64 %.055.reg2mem.0.i.i, i32 1, i1 false) nounwind
...
!16 = metadata !{i32 786484, i32 0, metadata !5, metadata !"rowbuf0", metadata !"rowbuf0", metadata !"", metadata !6, i32 71, metadata !17, i32 1, i32 1, [4096 x i8] * @krnl_sobel.rowbuf0} ; [ DW_TAG_variable ]
...
!21 = metadata !{i32 786484, i32 0, metadata !5, metadata !"rowbuf1", metadata !"rowbuf1", metadata !"", metadata !6, i32 72, metadata !17, i32 1, i32 1, [4096 x i8] * @krnl_sobel.rowbuf1} ; [ DW_TAG_variable ]
!22 = metadata !{i32 786484, i32 0, metadata !5, metadata !"rowbuf2", metadata !"rowbuf2", metadata !"", metadata !6, i32 73, metadata !17, i32 1, i32 1, [4096 x i8] * @krnl_sobel.rowbuf2} ; [ DW_TAG_variable ]
!23 = metadata !{i32 786484, i32 0, metadata !5, metadata !"resbuf", metadata !"resbuf", metadata !"", metadata !6, i32 74, metadata !17, i32 1, i32 1, [4096 x i8] * @krnl_sobel.resbuf} ; [ DW_TAG_variable ]
