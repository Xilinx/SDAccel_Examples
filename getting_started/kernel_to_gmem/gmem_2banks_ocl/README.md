...
***KEYWORDS:*** max_memory_ports, param:compiler.enablemap_connect, misc:map_connect, cl_mem_ext_ptr_t, XCL_MEM_DDR_BANK0, XCL_MEM_DDR_BANK1, XCL_MEM_DDR_BANKx, CL_MEM_EXT_PTR_XILINX
