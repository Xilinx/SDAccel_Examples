...
## 1. OVERVIEW
The vector dot-product example is a simple design which introduces the user to application development using the SDAccel environment.
...
Run the application as
    ```
    ./vdotprod.exe ./xclbin/krnl_vdotprod.<emulation flow>.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
    ```
...
Run the nimbix-run.py script provided in the utility/nimbix directory at the top level of this repository
    ```
    ../../utility/nimbix/nimbix-run.py ./vdotprod.exe ./xclbin/krnl_vdotprod.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
    ```
