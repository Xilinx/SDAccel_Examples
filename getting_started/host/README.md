...
[streaming_chain/][]|This is a simple Matrix Multiplication C Kernel design with multiple processes that demonstrates on how to process an input data for computation in an application using ap_ctrl_chain.|__Key__ __Concepts__<br> - ap_ctrl_chain<br> - PLRAM<br>
