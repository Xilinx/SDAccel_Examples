...
[overlap_ocl/][]|"This examples demonstrates techniques that allow you to overlap Host(CPU) and FPGA computation in an application. We will cover asynchronous operations and event object."|__Key__ __Concepts__<br> - OpenCL API<br> - Synchronize Host and FPGA<br> - Asynchronous Processing<br> - Events<br> - Asynchronous memcpy<br>__Keywords__<br> - cl_event<br> - clCreateCommandQueue<br> - CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE
