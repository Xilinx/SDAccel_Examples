Datflow Example Using HLS Stream Example 
======================
...
```
./host ./xclbin/N_stage_Adders.<emulation target>.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
...
```
../../../utility/nimbix/nimbix-run.py ./host ./xclbin/N_stage_Adders.hw.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
