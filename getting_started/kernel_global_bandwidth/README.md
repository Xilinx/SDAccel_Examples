...
```
./kernel_global ./xclbin/krnl_kernel_global.<emulation flow>.xilinx_adm-pcie-ku3_2ddr_3_1.xclbin
```
...
```
../../utility/nimbix/nimbix-run.py ./kernel_global ./xclbin/krnl_kernel_global.hw.xilinx_adm-pcie-ku3_2ddr_3_1.xclbin
```
