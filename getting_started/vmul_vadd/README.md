...
```
./vaddvmul_X86.exe ./xclbin/krnl_vmul.<emulation flow>.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin ./xclbin/krnl_vadd.<emulation flow>.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
```
...
```
../../utility/nimbix/nimbix-run.py ./vaddvmul_X86.exe ./xclbin/krnl_vmul.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin ./xclbin/krnl_vadd.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
```
