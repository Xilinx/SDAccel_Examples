Example based on vectod addition that demonstrates printing of work item data (integer products in this case) Example 
======================
...
## 1. OVERVIEW
This is simple example of vector addition and printing of data that is computational result (addition)
...
```
./host ./xclbin/vadd.<emulation target>.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
...
```
../../../utility/nimbix/nimbix-run.py ./host ./xclbin/vadd.hw.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
