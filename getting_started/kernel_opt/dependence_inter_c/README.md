Loop Iteration Dependency Example Using HLS Stream Example 
======================
...
```
./host ./xclbin/mean_value.<emulation target>.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
...
```
../../../utility/nimbix/nimbix-run.py ./host ./xclbin/mean_value.hw.xilinx_adm-pcie-ku3_2ddr_3_2.xclbin
```
