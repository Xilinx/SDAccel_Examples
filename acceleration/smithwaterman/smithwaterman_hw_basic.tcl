...
# 4b. Add kernel files
add_files -kernel [get_kernels opencl_sw_maxscore] "src/opencl_sw_maxscore_basic.cpp"
...
# 11. Generate reports
puts "PROF: report_estimate"
report_estimate

# 12. Build the entire system
puts "PROF: build_system"
build_system
