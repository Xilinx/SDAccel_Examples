...
```
../../utility/nimbix/nimbix-run.py ./huffman_X86.exe -p Xilinx -d 'xilinx:adm-pcie-ku3:2ddr:2.1' --kernel ./xclbin/krnl_huffman.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin data/rect_1024.bmp
```
