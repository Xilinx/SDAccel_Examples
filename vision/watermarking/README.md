...
```
./watermark_X86.exe data/inputImage.bmp ./xclbin/krnl_watermark.<emulation type>.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
```
...
```
../../utility/nimbix/nimbix-run.py ./watermark_X86.exe data/inputImage.bmp ./xclbin/krnl_watermark.hw.xilinx_adm-pcie-ku3_2ddr_2.1.xclbin
```
